...
import com.android11.storage.databinding.ActivityGalleryAlbumBinding
...
class BrowseGalleryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = ActivityGalleryAlbumBinding.inflate(layoutInflater)
        ...
        binding.recyclerView.viewTreeObserver.addOnPreDrawListener(object : OnPreDrawListener1 {
            override fun onPreDraw(): Boolean {
                ...
                val adapter = GalleryAdapter(this@BrowseGalleryActivity, imageList, checkedImages, imageSize, pickFiles)
                binding.recyclerView.layoutManager = GridLayoutManager(this@BrowseGalleryActivity, columns)
    ...
    private fun loadImages(adapter: GalleryAdapter) {
        thread {
